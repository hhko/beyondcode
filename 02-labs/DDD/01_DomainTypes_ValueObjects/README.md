...
우리가 만들고 사용하는 타입이 곧 비즈니스 규칙이 됩니다. 코드가 곧 문서이고, 코드가 곧 도메인 언어가 됩니다.  

이 과정은 **의미 있는 타입 설계, 입력 유효성 보장, 오류 처리의 명확화, 도메인 언어 강화** 등을 아우르며, 유지보수성과 안정성이 높은 코드를 구성하는 기반을 마련합니다.  

지금 당신이 개발 중인 도메인에서 규칙이 반복적으로 등장하는 값은 무엇인가요?
그 값을 Value Object로 분리할 필요가 있습니다.
Value Object 코드가 더 안전해지고, 명확해지고, 의미를 갖게 될 것입니다.