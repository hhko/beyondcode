...
internal sealed class CreateParticipantProfileUsecase(
    IUsersRepository usersRepository)
    : ICommandUsecase2<CreateParticipantProfile.Command, CreateParticipantProfile.Response>
{
    private readonly IUsersRepository _usersRepository = usersRepository;

    public async Task<Fin<CreateParticipantProfile.Response>> Handle(CreateParticipantProfile.Command request, CancellationToken cancellationToken)
    {
        ...
        return new CreateParticipantProfile.Response(participantId);
    }
