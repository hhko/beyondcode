...
internal sealed class CreateTrainerProfileUsecase(
    IUsersRepository usersRepository)
    : ICommandUsecase2<CreateTrainerProfile.Command, CreateTrainerProfile.Response>
{
    private readonly IUsersRepository _usersRepository = usersRepository;

    public async Task<Fin<CreateTrainerProfile.Response>> Handle(CreateTrainerProfile.Command request, CancellationToken cancellationToken)
    {
        ...
        return new CreateTrainerProfile.Response(trainerId);
    }
