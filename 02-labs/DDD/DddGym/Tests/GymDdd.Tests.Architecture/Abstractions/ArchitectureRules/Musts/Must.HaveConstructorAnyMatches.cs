...
{
    public static IArchitectureRule HaveConstructorAnyMatches<T>(
        ...
        where T : Class
    {
        ...
        foreach (var ctorCondition in matches)
        {
            builder.MustSatisfy(
                ...
                $"does not satisfy any constructor conditions");
        }

        string ruleName = $"must have any matching conditions";
