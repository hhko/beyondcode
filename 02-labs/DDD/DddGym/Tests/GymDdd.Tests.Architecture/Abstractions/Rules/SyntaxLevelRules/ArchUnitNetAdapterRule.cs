...
public sealed class ArchUnitNetAdapterRule : IArchitectureRule
{
    private readonly IArchRule _archRule;
    private readonly string _ruleName;

    public ArchUnitNetAdapterRule(IArchRule archRule, string ruleName)
    {
    ...
    //// ICanBeAnalyzed
    //private sealed class DummyAnalyzedObject : IAnalyzedObject
    //{
    //    public DummyAnalyzedObject(string fullName) => FullName = fullName;
