...
function Create-AbstractionStructure {
  $baseFrameworkPath = "${curDir}/Abstraction/Frameworks/${T1_CORPORATION}.${T2_SOLUTION}.Framework"
  ...
  # Domains
  $baseDomainPath = "${curDir}/Abstraction/Domains/${T1_CORPORATION}.${T2_SOLUTION}.Domain"
...
function Add-ServiceReferences {
  ...
  $frameworkPath = "${curDir}/Abstraction/Frameworks/${T1_CORPORATION}.${T2_SOLUTION}.Framework"
  $domainPath = "${curDir}/Abstraction/Domains/${T1_CORPORATION}.${T2_SOLUTION}.Domain"
