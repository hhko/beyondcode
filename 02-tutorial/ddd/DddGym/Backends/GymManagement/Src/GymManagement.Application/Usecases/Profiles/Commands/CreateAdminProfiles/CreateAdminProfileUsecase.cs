...
internal sealed class CreateAdminProfileUsecase(
    IUsersRepository usersRepository)
    : ICommandUsecase2<CreateAdminProfile.Command, CreateAdminProfile.Response>
{
    ...
    public async Task<Fin<CreateAdminProfile.Response>> Handle(CreateAdminProfile.Command request, CancellationToken cancellationToken)
    {
        ...
        return new CreateAdminProfile.Response(user.AdminId);
    }
}