...
public static partial class DomainErrors
{
    public static class CancelReservationErrors
    {
        ...
        public static readonly Error ReservationNotFound = Error.New(
            "Session reservation not found");

        public static readonly Error CannotCancelReservationTooCloseToSession = Error.New(
            "Cannot cancel the reservation too close to session start time");

        public static readonly Error CannotCancelPastSession = Error.New(
